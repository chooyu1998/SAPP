...
methylR_df <- read_xlsx('Rmethyl_test.xlsx')
phosphoY_df <- read_xlsx('Yphospho_test.xlsx')
acetylK_df <- read_xlsx('KAcetyl_test.xlsx')
methylK_df <- read_xlsx('KMethyl_test.xlsx')
sumoK_df <- read_xlsx('Ksumo_test.xlsx')
ubiquitinK_df <- read_xlsx('KUbi_test.xlsx')
