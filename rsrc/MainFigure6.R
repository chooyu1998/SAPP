...
CMGC_df <- read_xlsx('CMGC_test.xlsx')
CAMK_df <- read_xlsx('CAMK_test.xlsx')
CDK_df <- read_xlsx('CDK_test.xlsx')
AGC_df <- read_xlsx('AGC_test.xlsx')
MAPK_df <- read_xlsx('MAPK_test.xlsx')
PKA_df <- read_xlsx('PKA_test.xlsx')
PKC_df <- read_xlsx(('PKC_test.xlsx'))
CK2_df <- read_xlsx('CK2_test.xlsx')
